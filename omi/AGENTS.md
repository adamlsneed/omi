...
app side in `app/lib/services/devices.dart` (`OmiFeatures`). Example: recording-pause
is `1 << 10` in BOTH. The firmware advertises the bitmask over BLE and the app reads

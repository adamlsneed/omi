...
# instead.
# Fork note: upstream ships this gate at 178 for its own sources; this fork
# carries additional inline keys from fork-only desktop features that predate
# the gate. Still may only decrease.
BASELINE = 182

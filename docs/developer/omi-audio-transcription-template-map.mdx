...
1. Add a first-class template router.
   Use deterministic rules before the LLM suggestion step: source, calendar meeting title/attendees, folder, category, speaker/person, keywords, and preferred output type.

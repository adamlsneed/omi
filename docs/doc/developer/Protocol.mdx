...
| `21` | Opus FS320 | 16 kHz | 16-bit mono |
...
<Info>
Current consumer Omi firmware reports codec ID `21` (`opusFS320` in the mobile app). Older Opus firmware and tooling may still report codec ID `20`.
</Info>

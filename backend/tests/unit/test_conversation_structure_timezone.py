...
# conversation_processing imports folder helpers, but these tests isolate only
# timestamp conversion and transcript-structure behavior.
conversation_folder_stub = _stub_module("utils.llm.conversation_folder")
conversation_folder_stub.FolderAssignment = MagicMock()
conversation_folder_stub.assign_conversation_to_folder = MagicMock(return_value=(None, 0.0, "stubbed"))

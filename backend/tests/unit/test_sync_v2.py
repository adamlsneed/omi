...
class TestAsyncCoordinatorBehavioral:
    ...
    async def test_target_conversation_id_forwarded(self):
        ...
        try:
            ...
            def _capture_target(path, uid, response, lock, errors, source, is_locked, prefs, cache, target_cid, *args):
...
class TestBulkheadExecutors:
    ...
    def test_executor_worker_counts(self):
        ...
        assert storage_executor._max_workers == 128, "storage_executor must have 128 workers (#7526)"

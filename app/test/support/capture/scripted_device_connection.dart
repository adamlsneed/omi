...
class ScriptedDeviceConnection implements DeviceConnection {
  ...
  /// Firmware recording-pause commands the controller sent (fork: pendant pause feedback).
  final recordingPausedCalls = <bool>[];

  @override
  Future<void> setRecordingPaused(bool paused) async => recordingPausedCalls.add(paused);

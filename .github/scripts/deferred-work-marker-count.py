...
# Negative lookarounds: `.todo` is an enum-member/property access and
# `todo.txt` is a filename, not a deferred-work marker.
MARKER_RE = re.compile(r"(?<![.\w])(" + "|".join(MARKERS) + r")\b(?!\.\w)", re.IGNORECASE)
